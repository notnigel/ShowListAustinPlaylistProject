 ...
 */
public class WeekdayPlaylistController {
	/*
	 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		if (artists.size() < 101) {
			Playlist playlist = new Playlist(artists, PLAYLIST_ID);
			...
			while (artists.size() > 100) {
				...
				playlists.add(new Playlist(artists1, PLAYLIST_ID));
				artists.subList(0, 100).clear();
			}
			playlists.add(new Playlist(artists, PLAYLIST_ID));
